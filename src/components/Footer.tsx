...
export default function Footer() {
  return (
    <footer className="bg-vnx-navy text-white border-t border-white/10">
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-5 gap-8">
          ...
          <div className="lg:col-span-2">
            ...
            <div className="flex gap-3">
              <a href="#" className="w-10 h-10 rounded-full bg-white/10 flex items-center justify-center hover:bg-vnx-gold hover:text-vnx-navy transition-colors">
          ...
          {/* Giới thiệu */}
          <div>
            <h4 className="font-display font-semibold text-vnx-gold mb-4">Giới thiệu</h4>
          ...
          {/* Tin tức */}
          <div>
            <h4 className="font-display font-semibold text-vnx-gold mb-4">Tin tức</h4>
            <ul className="space-y-2">
          ...
          {/* Liên hệ */}
          <div>
            <h4 className="font-display font-semibold text-vnx-gold mb-4">Liên hệ</h4>
            <ul className="space-y-3">
              <li className="flex items-start gap-2 text-sm text-white/70">
                <MapPin className="h-4 w-4 mt-0.5 text-vnx-gold flex-shrink-0" />
                <span>Số 2, Phan Chu Trinh, Hoàn Kiếm, Hà Nội</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-white/70">
                <Phone className="h-4 w-4 text-vnx-gold flex-shrink-0" />
                <span>(84-24) 39412626</span>
              </li>
              <li className="flex items-center gap-2 text-sm text-white/70">
                <Mail className="h-4 w-4 text-vnx-gold flex-shrink-0" />
