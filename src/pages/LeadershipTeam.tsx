    ...
    <div className="min-h-screen bg-[#003366]">
      ...
      <main className="pt-[121px]">
        ...
        <div className="relative overflow-hidden bg-[#003366]" style={{ height: 110 }}>
          ...
          >
            <defs>
              <linearGradient id="swooshLeaders" x1="0%" y1="0%" x2="100%" y2="100%">
                <stop offset="0%" stopColor="hsl(145, 80%, 45%)" />
                <stop offset="50%" stopColor="hsl(80, 70%, 50%)" />
                <stop offset="100%" stopColor="hsl(25, 95%, 53%)" />
              </linearGradient>
            </defs>
            <path d="M100,0 Q180,20 220,50 T300,100 L300,0 Z" fill="url(#swooshLeaders)" opacity="0.15" />
            <path d="M120,0 Q200,30 250,60 T300,100" stroke="url(#swooshLeaders)" strokeWidth="4" fill="none" opacity="0.8" />
          </svg>
          <div className="container mx-auto px-4 relative z-10 h-full flex flex-col justify-center">
            ...
            <p className="text-white/60 text-sm">
              Đội ngũ lãnh đạo Sở Giao dịch Chứng khoán Việt Nam
            </p>
          </div>
        </div>
