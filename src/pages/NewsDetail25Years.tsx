        ...
        <div className="pb-16">
          <div className="container mx-auto px-4 py-8 md:py-12">
            <div className="max-w-4xl mx-auto">
              ...
              {/* Article Body */}
              <article className="bg-card rounded-xl border border-border p-6 md:p-10 shadow-sm">
                <p className="text-lg md:text-xl text-foreground/90 font-medium leading-relaxed mb-6">
                ...
                <div className="grid grid-cols-2 md:grid-cols-4 gap-4 my-8">
                  {[
                    ...
                    <div key={stat.label} className="bg-primary/5 border border-primary/10 rounded-xl p-4 text-center">
              ...
              <div className="flex items-center gap-3 mt-8">
                ...
                <button className="h-9 w-9 rounded-full border border-border bg-card flex items-center justify-center text-muted-foreground hover:text-primary hover:border-primary transition-colors">
